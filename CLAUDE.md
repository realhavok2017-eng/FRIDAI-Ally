...
```
Valence < -0.3 (sad) + OBSERVATION → priority × 0.7
Valence > 0.4 (happy) + OBSERVATION → priority × 1.15
Energy > 0.7 (high) + TACTICAL → priority × 1.2
Energy < 0.3 (low) + priority < 0.7 → priority × 0.6
```
